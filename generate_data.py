...
compras       = gen_compras(30, imoveis, clientes, corretores, coberturas)
publicidade   = gen_publicidades(50, imoveis, corretores, midias, coberturas)
...
relacionamentos.to_csv('data/relacionamentos.csv', index=False, columns=['IdRelacionamento', 'Tipo'])
