...
CREATE TABLE Mídia
  (
    IdMídia INT NOT NULL IDENTITY (1,1),
...
CREATE TABLE Área
  (
    IdÁrea INT NOT NULL IDENTITY (1,1),
...
CREATE TABLE Função
  (
    IdFunção INT NOT NULL IDENTITY (1,1),
    Tipo VARCHAR(30) NOT NULL,
...
CREATE TABLE Relacionamento
  (
    IdRelacionamento INT NOT NULL IDENTITY (1,1),
...
CREATE TABLE Imóvel
  (
    IdImóvel INT NOT NULL IDENTITY (1,1),
    IdÁrea INT NOT NULL,
    Endereço VARCHAR(100) NOT NULL,
...
CREATE TABLE Funcionário
  (
    IdFuncionário INT NOT NULL IDENTITY (1,1),
    Nome VARCHAR(50) NOT NULL,
    Telefone VARCHAR(50) NOT NULL,
    CPF VARCHAR(50) NOT NULL,
    Endereço VARCHAR(100) NOT NULL,
...
CREATE TABLE Corretor
  (
    IdCorretor INT NOT NULL IDENTITY (1,1),
...
CREATE TABLE Publicidade
  (
    IdPublicidade INT NOT NULL IDENTITY (1,1),
